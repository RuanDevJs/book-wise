...
export default function Aside({ data }: IProps) {
  const stars = Array.from({ length: data.star_rating }, (n, index) => index)
  return (
    <aside className="w-full mb-7 px-5 py-3 rounded-lg bg-[#181C2A] hover:brightness-110 hover:-translate-y-2 duration-150 transition ease-in-out cursor-pointer">
